...
#include "rf_patch_cpe_sl_longrange.h"
#include "rf_patch_mce_sl_longrange.h"
#include "rf_patch_rfe_sl_longrange.h"
...
uint32_t pOverrides[] =
{
    ...
    //HW_REG_OVERRIDE(0x505C,0x0100), // 5
    HW_REG_OVERRIDE(0x505C,0x0303), // 2.5
